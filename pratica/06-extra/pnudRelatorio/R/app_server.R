...
app_server <- function(input, output, session) {
  ...
  base_filtrada_1 <- mod_filtro_ano_server("filtro_ano_1", con)
  base_filtrada_2 <- mod_filtro_ano_server("filtro_ano_2", con)
  ...
  mod_leaflet_server("leaflet_1", con, base_filtrada_2)

  mod_documentacao_server("documentacao_1", con)
}
